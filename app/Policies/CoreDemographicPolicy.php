...
class CoreDemographicPolicy
{
     ...
     */
    public function view(User $user, CoreDemographic $demographic): bool
    {
     ...
     */
    public function update(User $user, CoreDemographic $demographic): bool
    {
     ...
     */
    public function delete(User $user, CoreDemographic $demographic): bool
    {
     ...
     */
    public function restore(User $user, CoreDemographic $demographic): bool
    {
        return $user->hasTeamPermission($demographic->team, 'delete');
    }
     ...
     */
    public function forceDelete(User $user, CoreDemographic $demographic): bool
    {
