...
class SeriesPolicy
{
    ...
    {
        return $user->hasTeamPermission($series->team, 'read');
    }
    ...
    {
        return $user->hasTeamPermission($series->team, 'update');
    }
    ...
    {
        return $user->hasTeamPermission($series->team, 'delete');
    }
    ...
    {
        return $user->hasTeamPermission($series->team, 'forceDelete');
    }
